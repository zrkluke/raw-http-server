...
- [ ] 1.2 Add a WSL-compatible unified command that builds and runs native tests for all three languages
- [ ] 1.3 Create the shared `testdata/` conventions and language-native fixture loaders
- [ ] 1.4 Configure strict C warnings and sanitizer checks, Go tests, and Rust tests plus lints
...
- [ ] 3.1 Add a failing black-box acceptance test for listen, connect, accept, byte transfer, and connection cleanup
- [ ] 3.2 Implement and unit-test the TCP listener path in Go
